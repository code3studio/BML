const { buildModule } = require("@nomicfoundation/hardhat-ignition/modules");
    ...
    //    const customErc20Template = m.getParameter("customErc20Template","0xE85c8ea9fD161dfE0a15fA0a2Bed8f2F71Dd6353");
    //    const customMintableErc20Template = m.getParameter("customMintableErc20Template","0x1E3787c4fB90E594a48326870cc9a64946ec0b0b");
    //    const customLiquidityErc20Template = m.getParameter("customLiquidityErc20Template","0x93E3e4be8b8615CB2ad5a80aCf444abA9e02cc48");
    //    const createFee = m.getParameter("createFee",100);
