...
contract AAAAAAAAAAAAToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    ...
    constructor(
        ...
        ERC20("AAAAAAAAAAAA", "AAA")
        Ownable(initialOwner)
        ERC20Permit("AAAAAAAAAAAA")
    {
        maxSupply = 1000000;
        emit Log("message", owner());

        teamAllocation = ((total_supply * (0)) / (100)) * 10 ** 18;
